      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="font-rubik text-gray-500 text-base max-w-lg mx-auto">
            Don&apos;t take our word for it — here&apos;s what local Illawarra homeowners and businesses have to say about Bluefin.
          </p>
          ...
          >
            ...
            <span className="text-gray-400 text-xs font-rubik">·</span>
            <span className="inline-flex items-center gap-1 text-xs font-rubik text-green-700 font-semibold bg-green-50 border border-green-200 px-2 py-0.5 rounded-full">
